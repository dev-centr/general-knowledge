...
It does not replace legal texts. Pair it with xref:platforms:publishing:licensing.adoc[Licensing (CSL / ANL)].
...
| **xref:platforms:publishing:licensing.adoc[Licensing]**
...
* xref:platforms:publishing:licensing.adoc[Licensing (CSL / ANL)]
* xref:platforms:publishing:licensing-strategy-templates.adoc[Licensing strategy templates]
