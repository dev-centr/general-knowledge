...
HCI framing (honesty of the tuner UI vs renderer scopes): link:https://hci-nerdz.github.io/docs/hci-nerdz/cleartype.html[HCI Nerdz — ClearType] · link:https://hci-nerdz.github.io/blog/cleartype-as-subpixel-rendering/[essay].
