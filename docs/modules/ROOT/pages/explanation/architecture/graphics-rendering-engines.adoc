...
It complements xref:explanation/architecture/types/gui-apps.adoc[GUI applications] and xref:home::explanation/architecture/ui-heavy-web-apps.adoc[UI-heavy web applications] (browser-heavy products on the Dev-Centr docs playbook).
...
* xref:home::explanation/architecture/ui-heavy-web-apps.adoc[UI-heavy web applications]
