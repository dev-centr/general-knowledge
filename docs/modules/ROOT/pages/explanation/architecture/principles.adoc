...
Do not force a GUI About dialog onto a library. Do not skip an installer because a CLI “works as a zip.” Use the xref:explanation/architecture/software-product-essentials.adoc#applicability-matrix[applicability matrix].

== Related

* xref:explanation/architecture/index.adoc[Architecture index]
* xref:explanation/writing-clear-docs-with-ai.adoc[Writing clear docs with AI] (when present)
