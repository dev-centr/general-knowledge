...
For day-to-day authoring of Markdown *on disk* (READMEs, project docs, vaults), see xref:explanation/documentation/markdown-editors-on-disk.adoc[Markdown editors on local disk] (SoloMD to edit, MarkView to view).
...
* Product Create… dialog: xref:platforms:specifications:components/content-create.adoc[Content Create]
* CentrMark overview: link:https://github.com/dev-centr/centrmark[dev-centr/centrmark]
* Structured *data* formats (not prose): xref:explanation/documentation/structured-data-formats.adoc[Structured data formats]
