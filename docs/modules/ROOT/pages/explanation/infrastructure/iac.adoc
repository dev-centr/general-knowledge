...
* xref:platforms:specifications:components/iac-discovery.adoc[IaC Discovery]
* xref:platforms:specifications:components/installation-workflow.adoc[Installation workflow]
