...
https://github.com/dev-centr/agent-rules/blob/main/skills/BOOTSTRAP.md[`agent-rules/skills/BOOTSTRAP.md`]
...
* **Business Bootstrap → …** — stand up the org (inbox, calendar, vault, …). GitHub identity in a hurry: xref:business-bootstrap::tutorials/fast-org-bootstrap.adoc[Fast org bootstrap] (Cursor skill `bootstrap-org`) — not this page.
...
TIP: Always-on User Rules are expensive. Skills load when the task matches **trigger words** in YAML `description` (or when you name the skill)—not a lay summary of what the skill does. Authoring: skill `write-a-skill`. Layout leftover: Cursor `create-skill`.
...
xref:how-to/bootstrap-cursor-skills.adoc#worked-example-writing-news-and-blog[Bootstrap Cursor skills — writing-news and writing-blog]
