...
TIP: Always-on User Rules are expensive. Skills load when the task matches **trigger words** in YAML `description` (or when you name the skill)—not a lay summary of what the skill does. Authoring: skill `write-skill`. Layout leftover: Cursor `create-skill`.
