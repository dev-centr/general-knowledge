...
| xref:platforms:specifications:features/scriptbook-system-playbooks.adoc[DevCentr Scriptbook spec]
| Product pointer (not SLP, not shell translation)

| xref:tools:equivalence-engine:host-awareness.adoc[Equivalence Engine: Host Awareness]
