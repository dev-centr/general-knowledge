...
The **Toolchain Management Protocol** is the set of standard, repeatable behaviors that avoid the onboarding trap. Full behavior list for implementers: xref:platforms:specifications:components/ecosystem-management.adoc#toolchain-management-protocol[Ecosystem Management — Protocol].
...
* xref:platforms:devcentr:project-vision.adoc[DevCentr Project Vision]
* xref:platforms:specifications:components/ecosystem-management.adoc[Ecosystem Management (spec)]
* xref:explanation/infrastructure/toolchain-control-plane.adoc[Toolchain Control Plane]
* xref:platforms:specifications:components/toolchain-management.adoc[DevCentr TCM component]
* xref:explanation/infrastructure/toolchain-framework.adoc[Toolchain Framework (TCF)]
* xref:tools:toolchain-framework:index.adoc[TCF practice kit]
