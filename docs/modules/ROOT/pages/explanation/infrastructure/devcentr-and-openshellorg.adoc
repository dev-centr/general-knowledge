...
See also: xref:explanation/infrastructure/nushell.adoc[Why We Recommend Nushell], xref:explanation/infrastructure/nushell-and-ai-agents.adoc[Nushell and AI agents], link:https://github.com/openshellorg/shell-architecture[shell-architecture], link:https://github.com/openshellorg/nu-require[nu-require], link:https://github.com/openshellorg/nu-emit[nu-emit], link:https://github.com/openshellorg/prohelp[prohelp], link:https://github.com/openshellorg/about[about].
