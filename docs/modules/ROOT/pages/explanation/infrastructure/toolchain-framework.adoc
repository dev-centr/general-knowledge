...
Practice kit on this hub: xref:tools:toolchain-framework:index.adoc[Toolchain Framework component].
...
* xref:platforms:specifications:components/toolchain-management.adoc[Toolchain Management (TCM)]
* xref:platforms:specifications:components/ecosystem-management.adoc[Ecosystem Management]
