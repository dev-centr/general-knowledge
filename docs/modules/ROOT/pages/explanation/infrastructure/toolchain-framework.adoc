...
The **Toolchain Framework (TCF)** is Dev-Centr’s *framework* for producing xref:explanation/infrastructure/toolchain-control-plane.adoc[Toolchain Control Plane] implementations.
...
Practice kit on this hub: xref:toolchain-framework::index.adoc[Toolchain Framework component].
