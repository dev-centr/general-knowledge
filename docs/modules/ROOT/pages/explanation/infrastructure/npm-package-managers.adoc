...
* Ecosystem management: xref:platforms:specifications:components/ecosystem-management.adoc[Ecosystem Management]
* pnpm store mechanics (detail): xref:explanation/infrastructure/pnpm-mechanics.adoc[pnpm Mechanics]
