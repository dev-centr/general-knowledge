...
* xref:explanation/infrastructure/uniprovider.adoc[UniProvider / Open Provider Registry] — shared discovery for online + offline runners (not another hard-coded Ollama-only unilayer)
