...
Related search map: xref:how-to/finding-windows-internals-docs.adoc[Finding Windows internals documentation]. Sibling topic (subpixel text, not colorimetry): xref:explanation/cleartype.adoc[ClearType].
