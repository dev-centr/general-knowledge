...
Before you name env vars, read xref:explanation/infrastructure/api-key-vs-token.adoc[API key vs token]—dashboard "tokens" are usually long-lived keys.
...
image::secrets-toolkit-badges.png[alt="CLI and MCP toolkit badges",width=640]
...
image::secrets-cli-session-redacted.png[alt="Redacted terminal: vault fields and hosting env list",width=640]
