...
image::secrets-toolkit-badges.png[Toolkit strip: vault, package manager, hosting, Pulumi, Cursor, MCP,width=640]
...
image::secrets-cli-session-redacted.png[Redacted CLI session showing vault custom fields and hosting env list,width=640]
