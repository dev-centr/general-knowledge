...
image::access-mock-github-consent-orgs.svg[Simplified mock: owning org granted; unrelated org already granted when restrictions are off; Access policy still one org]
